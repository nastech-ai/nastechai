...
class _DesktopBackupPaneState extends State<DesktopBackupPane> {
  ...
  WebDavConfig _buildConfigFromForm() {
    return WebDavConfig(
      ...
      path: _path.text.trim().isEmpty ? 'nastechai_backups' : _path.text.trim(),
  ...
  Future<void> _applyPartial({
    ...
    final cfg = WebDavConfig(
      ...
      path:
          path ??
          (_path.text.trim().isEmpty ? 'nastechai_backups' : _path.text.trim()),
                    ...
                    _ItemRow(
                      ...
                      trailing: SizedBox(
                        ...
                        child: TextField(
                          ...
                          decoration: _deskInputDecoration(
                            context,
                          ).copyWith(hintText: 'nastechai_backups'),
