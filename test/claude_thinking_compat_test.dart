...
data: {"type":"content_block_delta","index":0,"delta":{"type":"input_json_delta","partial_json":"{\\"query\\":\\"nastechai\\"}"}}

event: content_block_stop
data: {"type":"content_block_stop","index":0}

event: content_block_start
data: {"type":"content_block_start","index":1,"content_block":{"type":"web_search_tool_result","tool_use_id":"srv_1","content":[{"type":"web_search_result","title":"NasTech AI","url":"https://example.com"}]}}
...
''');
        ...
        final chunks = await ChatApiService.sendMessageStream(
          ...
          messages: const [
            {'role': 'user', 'content': '搜索一下nastechai'},
          ],
          stream: true,
        ).toList();
    ...
    test('history tool replay preserves thinking block signature', () async {
      ...
      final chunks = await ChatApiService.sendMessageStream(
        ...
        modelId: 'claude-sonnet-4-6',
        messages: const [
          {'role': 'user', 'content': '查一下 NasTech AI'},
          {
            'role': 'assistant',
            'content': '\n\n',
            'tool_calls': [
...
event: content_block_delta
data: {"type":"content_block_delta","index":1,"delta":{"type":"input_json_delta","partial_json":"{\\"query\\":\\"NasTech AI\\"}"}}
